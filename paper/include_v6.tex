...
%% Custom enumerations. See documentation of package 'enumitem' for
%% more info. Do not use the package "enumerate", which is
%% incompatible and very limited.
...
%% \end{enumerate}
%%
%% You can use: \Alph*, \alph*, \Roman*, \roman* and \arabic*
...
% \clearpage
% \eject \pdfpagewidth=33.1in \pdfpageheight=46.8in
% Tall page
...
%%%%%%%%%%%%%% BEGIN: DO-NOT-EDIT REGION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\usepackage{savesym} %% Needed for compatibility with IEEEtran
\savesymbol{labelindent}
\usepackage{enumitem} % do not include the package enumerate. See below.
\newcommand{\acom}[1]{\textcolor{red}{{[#1]}}} % author comment
\newcommand{\arev}[1]{\textcolor{blue}{#1}} % author revision
%\usepackage{hyperref} --> conflicts with xcite

\if\editmode1  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% %% % Edit mode
\usepackage[backend=bibtex,style=alphabetic,sorting=debug,maxbibnames=99]{biblatex}
\DeclareFieldFormat{labelalpha}{\thefield{entrykey}}
\DeclareFieldFormat{extraalpha}{}
\bibliography{\bibfilenames}
\newcommand{\cmt}[1]{\noindent\textcolor{darkgreen}{\underline{[#1]}}} % comment
\newcommand{\hc}[1]{\textcolor{blue}{#1}} % highlight command --> to
% know which symbol is
% defined as a command

% List with 9 nesting levels
\setlistdepth{9}
\newlist{bulletlist}{enumerate}{9}
\setlist[bulletlist,1]{label=$\bullet$}
\setlist[bulletlist,2]{label=$\diamond$}
\setlist[bulletlist,3]{label=$\rightarrow$}
\setlist[bulletlist,4]{label=$\circ$}
\setlist[bulletlist,5]{label=$\square$}
\setlist[bulletlist,6]{label=$\star$}
\setlist[bulletlist,7]{label=$\checkmark$}
\setlist[bulletlist,8]{label=$\Delta$}
\setlist[bulletlist,9]{label=$-$}
\newenvironment{bullets}{\begin{bulletlist}}{\end{bulletlist}}

\newcommand{\blt}[1][noargpassed]{% add a label if an optional argument is passed
  \item%
  \ifthenelse{\equal{#1}{noargpassed}}{}{\cmt{#1}}%
}
...
\newcommand{\blt}[1][noargpassed]{\ignorespaces}
%\newcommand{\blt}{}
...
\newenvironment{mycolorquestion}
        { \begin{colbox}{lightblue}
\color{black}    \begin{myquestion}\normalfont}
        {\end{myquestion}
 \end{colbox}  
}
...
\makeatletter
\newtoks\@soltoks
\newcommand\printquizsolutions{%
  \the\@soltoks}
\newcommand\quizsolution[1]{%
  \begin{flushright}
    See the solution \hyperref[{qxsol:\themyquiz}]{here}.
  \end{flushright}
  \edef\@soltemp{%
    \the\@soltoks % the previously stored solutions
    \noexpand\solutionpreamble{\themyquiz}
    \unexpanded{
      #1
    }%
  }
...
\newcommand{\solutionpreamble}[1]{%
  \par\medskip\noindent\section{Solution to Quiz~\ref{qx:#1}}\label{qxsol:#1}\enspace\ignorespaces
}
\makeatother


\newenvironment{mycolorquiz}
        { \begin{colbox}{pistachio}
\color{black}    \begin{myquiz}\label{qx:\themyquiz}
\normalfont}
        {\end{myquiz}
 \end{colbox}  
}
...
% trick to avoid italic in myproblem
\newtheorem{myauxproblem}{Problem}
% \newenvironment{myproblem}
%          { \color{black}    \begin{myauxproblem}\normalfont}
%          {\end{myauxproblem} }
 \newenvironment{myproblem}
        { 
\color{black}    \begin{myauxproblem}\normalfont}
...
% trick to avoid italic in myproblem
\newtheorem{myauxoptionalproblem}{Optional Problem}
% \newenvironment{myproblem}
%          { \color{black}    \begin{myauxproblem}\normalfont}
%          {\end{myauxproblem} }
 \newenvironment{myoptionalproblem}
        { 
\color{black}    \begin{myauxoptionalproblem}\normalfont}
        {\end{myauxoptionalproblem}
}


\newenvironment{salign}[1][0]{\subequations \if#10  \else \label{#1} \fi \align}{\endalign\endsubequations}
% Syntax:
%
% - Without global label:
% \begin{salign}
%  stuff
% \end{align}
%
% - With a global label:
% \begin{salign}[eq:mylabel]
%  stuff
% \end{align}
%
% If you get an error 'innaccessible' when you use \bm inside, use the
% second option above, ie., with a label. We need to investigate why
% this happens...
...
\definecolor{pistachio}{RGB}{204,255,153}
...
\newcommand{\reb}[1]{\mathop{\rm Re}\brackets{#1}}
\newcommand{\im}{\mathop{\rm Im}}
\newcommand{\imb}[1]{\mathop{\rm Im}\brackets{#1}}
\newcommand{\cov}{\mathop{\rm Cov}}
\newcommand{\covb}[2]{\mathop{\rm Cov}\left\{#1,#2\right\}}
\newcommand{\diag}{\mathop{\rm diag}}
\newcommand{\diagb}[1]{\mathop{\rm diag}\brackets{#1}}
\newcommand{\toep}{\mathop{\rm toep}}
\newcommand{\toepb}[1]{\mathop{\rm toep}\brackets{#1}}
\newcommand{\bdiag}{\mathop{\rm bdiag}}
\newcommand{\bdiagb}[1]{\mathop{\rm bdiag}\brackets{#1}}
...
\newcommand{\defectb}[1]{\mathop{\rm def}\brackets{#1}}
\newcommand{\range}{\mathcal{R}}
\newcommand{\rangeb}[1]{\mathcal{R}\brackets{#1}}
\newcommand{\nullspace}{\mathcal{N}}
\newcommand{\nullspaceb}[1]{\mathcal{N}\brackets{#1}}
...
\newcommand{\signb}[1]{\mathop{\rm sign}\brackets{#1}}
...
\newcommand{\prob}{\mathop{\textrm{P}} }
\newcommand{\probb}[1]{\mathop{\textrm{P}} \brackets{#1} }

\newcommand{\expected}{\mathop{\textrm{E}}\nolimits}
\newcommand{\expectedb}[1]{\mathop{\textrm{E}}\brackets{#1} }
\newcommand{\expectedwrt}[2]{\mathop{\textrm{E}}\nolimits_{#1}\{#2\}}
\newcommand{\expb}[1]{\exp \brackets{#1} }
\newcommand{\var}{\mathop{\textrm{Var}}}
\newcommand{\varb}[1]{\mathop{\textrm{Var}}\brackets{#1} }
...
\newcommand{\lagrangian}{{\hc{\mathcal{L}}}}
...
\newtheorem{myquiz}{Quiz}
\newtheorem{myremark}{Remark}
\newtheorem{myproblemstatement}{Problem}
\newtheorem{mylemma}{Lemma}
\newtheorem{mytheorem}{Theorem}
\newtheorem{mydefinition}{Definition}
\newtheorem{mycorollary}{Corollary}
\newtheorem{myexample}{Example}
\newenvironment{myproofsketch}{\emph{Proof sketch:}}{\hfill $\blacksquare$}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Use the following to break equations across pages
% \allowdisplaybreaks
