...
\setlist[bulletlist,5]{label=$-$}
\setlist[bulletlist,6]{label=$\square$}
\setlist[bulletlist,7]{label=$\star$}
\setlist[bulletlist,8]{label=$\checkmark$}
\setlist[bulletlist,9]{label=$\Delta$}
